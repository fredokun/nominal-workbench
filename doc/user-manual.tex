...
The predicates are : 
\begin{itemize}
\item \texttt{-{}-equal} -- Tests that the given term equals the resulting term.
\item \texttt{-{}-in} -- Tests that the given term or one of the term
  reduction (if rewritted) equals the resulting term or any of the
  term reduction (also if rewritted).
